...
that all cards are given at random, o when players purchase cards they can't 
...
So, even though the probability of getting exactly one E.T. Jaynes card is only 0.352
(35%), the probability of pulling at least one is is high enough to risk it. 
